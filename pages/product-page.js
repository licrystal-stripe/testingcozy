...
export default function ProductPage() {
  ...
  const productToBuyJSON = JSON.parse(productClicked)
  ...
  const handleEmbeddedComponent = (e) => {
    e.preventDefault();
    console.log("made it in handle embedded component")
    // Pass openCart, itemsInCart, and subtotal as query parameters
    router.push({
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4 flex">
                  <a href="#" className="text-sm font-medium text-[#a99a78] hover:text-[#1e2525]">
