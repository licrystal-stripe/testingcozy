...
export default function OrderHistory() {
    const [theOrders, setOrders] = React.useState([]);
    // call the get-customer-order api to get the previous orders
    React.useEffect(() => {

        fetch("/api/get-customer-order", {
            method: "GET",
    ...
    const handleRefund = (e, selectedProduct) => {
        e.preventDefault();
                ...
                >
                  ...
                  <div className="flex items-center border-b border-gray-200 p-4 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
                    <dl className="grid flex-1 grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-3 lg:col-span-2">
                      <div>
                        <dt className="font-medium text-gray-900">Receipt number</dt>
                        <dd className="mt-1 text-gray-500">{order.receipt_number}</dd>
                      </div>
                    ...
                    <div className="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:space-x-4">
                      <button className='"flex items-center justify-center rounded-md border border-gray-300 bg-white px-2.5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"'
                        ...
                        <div className="mt-6 sm:flex sm:justify-between">
                          <div className="flex items-center">
                            ...
                            <p className="ml-2 text-sm font-medium text-gray-500">
                              Delivered on <time dateTime={order.created}>{order.created}</time>
                            </p>
                          </div>
