            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  <button
                    type="submit"
                    className="w-full rounded-md border border-transparent bg-[#ece1c7] px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-[#e2d2ac] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                  >
                    Confirm order
                  </button>
                </div>
